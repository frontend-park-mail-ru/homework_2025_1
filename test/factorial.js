...
QUnit.module('Тестируем функцию factorial', () => {
    ...
    QUnit.test('Факториал от 25 должен быть 15511210043330985984000000', (assert) => {
        assert.strictEqual(factorial(25), BigInt('15511210043330985984000000'), '25! = 15511210043330985984000000');
    });
